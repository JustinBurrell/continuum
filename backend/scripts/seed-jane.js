...
async function seedNotifications(jane, friends, sharedNotes, allComments, conversations) {
  ...
  const entries = [
    ...
    (janeReplyAuthor && replyToJane && replyToJaneParent) ? {
      ...
      targetType: 'comment',
      message: `${janeReplyAuthor.firstName} replied to your comment`,
      metadata: {
      ...
      targetType: 'comment',
      message: 'Ryan replied to your comment',
      metadata: {
    ...
    chris && janeSharedTask && {
      ...
      targetType: 'task',
      message: `Chris assigned you to a task: "${janeSharedTask.title}"`,
      read: false,
    ...
    chris && chrisNote && {
      ...
      targetType: 'note',
      message: `Chris shared a note with you: "${chrisNote.title}"`,
      read: false,
      createdAt: daysAgo(4),
    },
    logan && janeReply && {
