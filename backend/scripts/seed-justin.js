...
async function seedNotifications(justin, friends, justinNotes, comments, conversations) {
  ...
  const entries = [
    ...
    marcus && justinReply && {
      ...
      targetType: 'comment',
      message: 'Marcus Johnson liked a comment on your note',
      metadata: justinReply ? { commentPreview: justinReply.content?.slice(0, 120), commentId: justinReply._id.toString(), resourceId: justinReply.targetId?.toString(), resourceType: justinReply.targetType } : undefined,
      read: false,
    ...
    sofia && justinReply && {
      ...
      targetId: justinReply._id,
      targetType: 'comment',
      message: 'Sofia Rodriguez liked a comment on your note',
      metadata: justinReply ? { commentPreview: justinReply.content?.slice(0, 120), commentId: justinReply._id.toString(), resourceId: justinReply.targetId?.toString(), resourceType: justinReply.targetType } : undefined,
      read: true,
      readAt: daysAgo(4),
      createdAt: daysAgo(5),
