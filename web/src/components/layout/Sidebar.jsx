...
const prefetchMap = {
  ...
  '/tasks':        () => queryClient.prefetchInfiniteQuery({ queryKey: ['tasks', 'mine', ''], queryFn: ({ pageParam = 1 }) => api.get('/tasks', { params: { page: pageParam, limit: 20 } }).then(r => r.data), initialPageParam: 1, getNextPageParam: (last) => { const p = last?.pagination; return p && p.page < p.pages ? p.page + 1 : undefined; }, staleTime: 30_000 }),
